<template>
    ...
    <div class="container">
        <div class="form-group">
            ...
            <input class="form-input" type="text" placeholder="Crie um nome para a transação">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-input" type="text" placeholder="Escreva seus comentários e #tags">
        </div>
        <div class="form-group">
